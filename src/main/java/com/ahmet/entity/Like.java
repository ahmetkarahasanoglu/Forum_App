...
public class Like {
    ...
    @JoinColumn(name="user_id", nullable=false) // This 'user_id' will reference the 'id' column in the 'user' table. 'nullable=false' means the 'user_id' column can't be null; which means that every post must be associated with a user.
